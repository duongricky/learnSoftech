...
<body>
    <?php
        ...
        */
       //Insert data use OOP
       include 'functions/function_oop_product.php';
       $Product_1 = new Product();
            $product_name     = $product_info = $product_price = $product_discount = "";
        if (isset($_POST['add_products'])) {
            $product_name     = $_POST['product_name'];
            $product_info     = $_POST['product_info'];
            $product_price    = $_POST['product_price'];
            ...
            $product_picture  = $_FILES['product_picture'];
            $Product_1->InsertData($product_name,$product_info,$product_price,$product_picture,$product_discount);
        }
    ?>
